...
/*
  ...
  Write access to the OFFICIAL channel is restricted to the team head (or
  organizer) — enforce with Team.isTeamHead() before calling postMessage()
  for channel_type='team_official'. Unofficial groups are open write for
  any team member.
*/
